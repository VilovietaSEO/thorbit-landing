  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 md:p-6">
        <div
          className="bg-white rounded-2xl w-full max-w-7xl h-[95vh] md:h-[90vh] flex overflow-hidden border-2 border-primary/30"
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto icp-modal-content bg-[var(--bg-primary)]" ref={contentRef}>
            ...
            <div className="md:hidden sticky top-0 z-10 bg-white border-b border-border-light p-4 flex justify-between items-center">
              <h3 className="font-medium text-text-primary">ICP Document</h3>
              <button
                onClick={onClose}
                className="p-2 rounded-full hover:bg-bg-hover transition-all text-primary"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
