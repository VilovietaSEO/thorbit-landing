...
export default function GraphSidebar({ node, onClose, onNodeClick }: GraphSidebarProps) {
  ...
  return (
    <div className="bg-white p-6 h-full overflow-y-auto rounded-lg" style={{ backgroundColor: '#FFFFFF' }}>
      {/* Header */}
      <div className="flex items-start justify-between mb-6 gap-3 pb-4 border-b-2" style={{ borderColor: 'var(--primary)' }}>
        <h3 className="text-xl font-black flex-1" style={{ color: 'var(--primary)' }}>{node.name}</h3>
        ...
        <button
          onClick={onClose}
          className="flex-shrink-0 p-1.5 rounded-full transition-all hover:bg-primary/10"
      ...
      {node.coverage && (
        <div className="mb-4 pb-4 border-b border-border">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Coverage</h4>
      ...
      {keywords.length > 0 && (
        <div className="mb-4 pb-4 border-b border-border">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Keywords</h4>
      ...
      {synonyms.length > 0 && (
        <div className="mb-4 pb-4 border-b border-border">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Synonyms</h4>
          <div className="flex flex-wrap gap-2">
      ...
      {Object.keys(connectionStats).length > 0 && (
        <div className="mb-4 pb-4 border-b border-border">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Connection Statistics</h4>
      ...
      {Object.keys(relationships).length > 0 && (
        <div className="mb-4 pb-4 border-b border-border">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Relationships</h4>
      ...
      {useCases.length > 0 && (
        <div className="mb-4 pb-4 border-b border-border">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Use Cases</h4>
      ...
      {queryIntents.length > 0 && (
        <div className="mb-4 pb-4 border-b border-border">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Search Queries</h4>
          <ul className="space-y-1">
          ...
          {Object.entries(contentSections).map(([sectionKey, sectionContent]: [string, any]) => {
            ...
            return content ? (
              <div key={sectionKey} className="mb-4 pb-4 border-b border-border">
                <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>{sectionTitle}</h4>
      ...
      {Object.keys(referencedBy).length > 0 && (
        <div className="mb-4">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Referenced By</h4>
      ...
      {!contentSections.overview && description && (
        <div className="mb-4 pb-4 border-b border-border">
          <h4 className="text-sm font-semibold mb-2" style={{ color: "var(--primary)" }}>Description</h4>
