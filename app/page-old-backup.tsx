...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary">
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-bg-tertiary rounded-2xl p-8 border border-border-light">
              <p className="text-sm text-text-tertiary mb-4 font-medium uppercase tracking-wide">24-SECTION ICP FRAMEWORK</p>
              <div className="grid grid-cols-2 gap-3 text-sm mb-6">
                {["Avatar", "Before/After State", "Decision Triggers", "Primary Goals", "Secondary Goals", "Dreams", "Promises", "Primary Complaint", "Secondary Complaint", "Negative Statistics", "Objections", "Bad Habits", "Consequences", "Enemy", "Ultimate Fear", "False Solution Lie", "False Solution Truth", "False Solution Tip", "Mistaken Belief Truth", "Mistaken Belief Name", "Success Myth Lie", "Success Myth Truth", "What They Tried", "Why It Failed"].map((item, i) => (
                  <div key={i} className="flex items-center gap-2 py-2 px-3 rounded bg-white/70">
                    <div className="w-1.5 h-1.5 rounded-full bg-high flex-shrink-0"></div>
      ...
      {/* Strategic Brief & Content Section */}
      <section className="py-24 px-6 bg-gradient-to-br from-bg-secondary to-bg-tertiary">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg font-light text-text-secondary leading-relaxed max-w-3xl mx-auto">
              Every entity becomes a strategic brief. Every brief becomes comprehensive content. All aligned to your ICP.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {/* Strategic Brief Card */}
            <div className="bg-bg-primary rounded-2xl p-8 border border-border-light hover:border-primary/30 transition-all">
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-black text-text-primary mb-3">Strategic Brief</h3>
                <p className="text-text-secondary font-light mb-6">
                  ICP-aware content planning that maps search intent to your customer's journey. Research-backed sections that answer real questions.
                </p>
              </div>

              <div className="space-y-3 mb-6">
                {["Query Intent Analysis", "Section Mapping", "Research Integration", "ICP Alignment Scoring"].map((item, i) => (
            ...
            <div className="bg-bg-primary rounded-2xl p-8 border border-border-light hover:border-primary/30 transition-all">
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-black text-text-primary mb-3">Published Content</h3>
                <p className="text-text-secondary font-light mb-6">
                  Complete articles written from strategic briefs. Research-integrated, SEO-optimized, and ready to publish.
                </p>
              </div>

              <div className="space-y-3 mb-6">
                {["Research-Backed Writing", "SEO Optimization", "Internal Linking", "Multi-Platform Ready"].map((item, i) => (
                  <div key={i} className="flex items-center gap-2 text-sm">
